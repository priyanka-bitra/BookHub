<html>
	...
	<body>
	<?php
	//check if the email entered has '@gmu.edu'
	//the password check on line 52 is fishy. need to check again if it can be done like that
	...
	<form action="http://localhost/~amarbat/register_page.php/">
	...
	<br>
	Confirm Password:<br>
	<input type="text" name="passwordOne" value=" ">
	<br>
